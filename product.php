...
<div class="btn-group">
<a href="?cmd=product" class="btn btn-secondary">Quản lý chung</a>
<a href="?cmd=product&act=add" class="btn btn-primary">Thêm mới</a>
</div>
<?php
switch($act)
{
...
<td>'.$row['date'].'</td>
<td>
	<a href="index.php?cmd=product&act=edit&id='.$row['id'].'">
		<i class="fa fa-edit"></i>
	</a>
</td>
<td>
	<a href="index.php?cmd=product&act=del&id='.$row['id'].'">
...
if(isset($_POST['submit']))
{
	...
	$query="insert into product (`name`,`email`,`password`,`img`,`description`) 
